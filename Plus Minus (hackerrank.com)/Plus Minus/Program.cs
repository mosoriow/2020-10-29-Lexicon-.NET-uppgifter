 ...
 * Example
 * arr=[1,1,0,-1,-1]
 * There are n=5 elements, two positive, two negative and one zero. Their ratios are 2/5, 2/5 and
 * 1/5
 * 
 ...
 * printed on a separate line with 6 digits after the decimal. The function should not return a 
 * value.
 * 
 * Input Format
 ...
 * The proportions of occurrence are positive: 0.50, negative: 0.33 and zeros: 0.17. 
 */
...
namespace Plus_Minus
{
    class Program
    {
        static void plusMinus(int[] arr)
        {
            ...
            Console.WriteLine(plus / total);
            Console.WriteLine(minus / total);
            Console.WriteLine(zero / total);
        }
